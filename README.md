...
Aplicação que simula uma batalha do jogo Pokemon, feita para praticar alguns conceitos na aplicações de regras complexas.
...
> ⚠️ O servidor de desenvolvimento será iniciado na porta: 3333 - Acesse <http://localhost:3333>
...
| :--------------------------------------------------------: |
| [Parcel 1.12.4](https://parceljs.org/getting_started.html) |
|           [SASS 1.32.5](https://sass-lang.com/)            |
...
|            :page_facing_up:             |
| :-------------------------------------: |
|      Batalha contra outra pokemon       |
| Calculo de dano de acordo com a tipagem |
